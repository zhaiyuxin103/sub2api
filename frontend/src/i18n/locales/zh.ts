export default {
  ...
  auth: {
    ...
    verificationCodeHint: '请输入发送到您邮箱的 6 位验证码',
    sendingCode: '发送中...',
    sendCode: '发送验证码',
  ...
  keys: {
    ...
    customKeyHint: '仅允许字母、数字、下划线和连字符，最少 16 个字符。',
    customKeyTooShort: '自定义密钥至少需要 16 个字符',
  ...
  admin: {
    ...
    subscriptions: {
      ...
      adjustHint: '输入正数延长订阅，负数缩短订阅（缩短后剩余天数需大于 0）',
      assign: '分配',
      assigning: '分配中...',
      adjust: '调整',
      adjusting: '调整中...',
      ...
      validityDaysRequired: '请输入有效的天数（至少 1 天）',
    ...
    accounts: {
      ...
      quotaControl: {
        ...
        cacheTTLOverride: {
          label: '缓存 TTL 强制替换',
          hint: '将所有缓存创建 token 强制按指定的 TTL 类型（5 分钟或 1 小时）计费',
          target: '目标 TTL',
      ...
      last30DaysUsage: '近 30 天使用统计（日均基于实际使用天数）',
      stats: {
        totalCost: '30 天总费用',
        accumulatedCost: '累计成本',
        standardCost: '标准计费',
        totalRequests: '30 天总请求',
        totalCalls: '累计调用次数',
        avgDailyCost: '日均费用',
    ...
    ops: {
      ...
      errorCount: '错误数',
      upstreamErrors: '上游错误',
      errorCountExcl429529: '错误数（排除 429/529）',
      sla: 'SLA（排除业务限制）',
      ...
      other: '其他',
      errorsSla: '错误（SLA范围）',
      upstreamExcl429529: '上游（排除 429/529）',
      ...
      settings: {
        ...
        cleanupScheduleHint: '例如：0 2 * * * 表示每天凌晨 2 点',
        ...
        validation: {
          ...
          slaMinPercentRange: 'SLA最低百分比必须在 0-100 之间',
          ttftP99MaxRange: 'TTFT P99 最大值必须大于等于 0',
          requestErrorRateMaxRange: '请求错误率最大值必须在 0-100 之间',
          upstreamErrorRateMaxRange: '上游错误率最大值必须在 0-100 之间'
        }
      },
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 Relay AI 用户登录',
      ...
      streamTimeout: {
        ...
        timeoutSecondsHint: '流数据间隔超过此时间视为超时（30-300 秒）',
        action: '处理方式',
        ...
        tempUnschedMinutesHint: '临时不可调度的持续时间（1-60 分钟）',
        thresholdCount: '触发阈值（次数）',
        thresholdCountHint: '累计超时多少次后触发处理（1-10 次）',
        thresholdWindowMinutes: '阈值窗口（分钟）',
        thresholdWindowMinutesHint: '超时计数的时间窗口（1-60 分钟）',
        saved: '流超时设置保存成功',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 Relay AI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Relay AI 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 Relay AI 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
      ...
      accountName: {
        title: '✏️ 1. 账号名称',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">为账号设置一个便于识别的名称。</p><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 命名建议：</b>"Claude主账号"、"GPT备用 1"、"测试账号" 等</p></div>',
        nextBtn: '下一步'
      },
      accountPlatform: {
        title: '🤖 2. 选择平台',
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 Relay AI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 Relay AI AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
